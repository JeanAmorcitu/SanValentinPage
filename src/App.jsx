...
function App() {
  ...
  {
    id: 7,
    description: "Jejeje intenta nuevo.",
    img: "https://i.pinimg.com/originals/db/aa/c1/dbaac13f6278b91a15e480752b8a7242.gif"
  },
  {
    id: 8,
    description: "Si no aceptas lloro amorcitu.",
    img: "https://media.tenor.com/cbEccaK9QxMAAAAi/peach-goma.gif"
  },
  {
    id: 9,
    description: "Confía en mí amorcituu sera supeer.",
    img: "https://i.pinimg.com/originals/db/aa/c1/dbaac13f6278b91a15e480752b8a7242.gif"
  },
  {
    id: 10,
    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5xl text-center">¿Amorcitu quieres ser mi San Valentin?</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5 items-center">
              ...
              >
                ...
                <span hidden>{document.title = Object.keys(randomValor).length === 0 ? "¿Amorcituu quieres ser mi San Valentin?" : randomValor.description}</span>
              </button>
            </div>
          </div>
        ) : (
          <div className="flex justify-center items-center flex-col space-y-10">
            <h1 className="text-4xl text-white font-bold">Yeihhh superr mi amoor ❤️!</h1>
            <img src="https://i.pinimg.com/originals/9b/dc/c6/9bdcc6206c1d36a37149d31108c6bb41.gif" alt="" className="mx-auto" />
            <span hidden>{document.title = 'Yeihhh superr mi amoor ❤️!'}</span>
          </div>
        )
      }
    </main>
